<template>
  <div>
    {{ profile.hate_genres }}
    <h1>profile.like_popular_movie</h1>
    {{ profile.like_popular_movies }}
    <!-- {{ profile.like_popular_movies }}
    {{ profile.movie_review }} -->
    <h1>
      <b>{{ profile.username }}'s Page</b>
    </h1>
    <hr />
    <div class="card">
      <div class="card-body">
        ...
        <ul class="list-inline">
          <li
            ...
            v-for="genre in profile.hate_genres"
            :key="genre.name + 'f'"
          >
    ...
    <div class="container mb-5">
      ...
      <div
        class="
          ...
          row row row-cols-3 row-cols-sm-3 row-cols-md-4 row-cols-lg-6
          g-0
        "
      >
        <div
    ...
    <div
      class="list-group"
      v-for="movie in profile.movie_review"
      :key="movie.title + 'a'"
    >
      <router-link
